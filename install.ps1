<#
	.SYNOPSIS
		Installs the UserRightsAssignment Module from github
		
	.DESCRIPTION
		This script installs the UserRightsAssignment Module from github.
