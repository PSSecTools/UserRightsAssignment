...
Remove-Module UserRightsAssignment -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\UserRightsAssignment.psd1"
Import-Module "$PSScriptRoot\..\UserRightsAssignment.psm1" -Force
